...
function Profile() {
    ...
    const fetchUserListings = async () => {
        ...
        try {
            const response = await fetch(`https://Auction-postship-env.eba-pzad7jme.us-east-1.elasticbeanstalk.com/get-user-listing`, {
                method: 'GET',
                headers: {
    ...
    const fetchUserBids = async () => {
        ...
        try {
            const response = await fetch(`https://Auction-postship-env.eba-pzad7jme.us-east-1.elasticbeanstalk.com/get-user-bids`, {
                method: 'GET',
                headers: {
                    Authorization: `Bearer ${token}`,
                },
